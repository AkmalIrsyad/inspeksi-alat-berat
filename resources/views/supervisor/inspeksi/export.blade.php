    ...
    <div class="info-section">
        <div class="info-grid">
            ...
            <div class="info-item">
                ...
                <div class="info-item">
                <label>Jenis:</label>
                <span>{{ $inspeksi->alatBerat->jenis }}</span>
            </div>
            <div class="info-item">
            ...
            <div class="info-item">
                ...
                <span class="status-badge
                    @if($inspeksi->status == 'Approved') status-baik
                    @elseif($inspeksi->status == 'Cancel') status-rusak
        ...
        <table class="components-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <span class="status-badge
                            @if($komponen->pivot->status == 'OK') status-baik
                            @elseif($komponen->pivot->status == 'NO') status-rusak
                            @else status-perlu-perhatian
                            @endif">
